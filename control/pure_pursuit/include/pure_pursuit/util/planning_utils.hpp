...
double calcArcLengthFromWayPoint(const autoware_auto_planning_msgs::msg::Trajectory & input_path, 
                                 const size_t src_idx,
                                 const size_t dst_idx);

double calcCurvature(const geometry_msgs::msg::Point & target, 
...
double calcLateralError2D(const geometry_msgs::msg::Point & a_start, 
                          const geometry_msgs::msg::Point & a_end,
                          const geometry_msgs::msg::Point & b);

double calcRadius(const geometry_msgs::msg::Point & target, 
                  const geometry_msgs::msg::Pose & current_pose);

double convertCurvatureToSteeringAngle(double wheel_base, double kappa);

std::vector<geometry_msgs::msg::Pose> extractPoses(const autoware_auto_planning_msgs::msg::Trajectory & motions);

std::pair<bool, int32_t> findClosestIdxWithDistAngThr(const std::vector<geometry_msgs::msg::Pose> & poses,
                                                      const geometry_msgs::msg::Pose & current_pose, 
                                                      const double th_dist = 3.0,
                                                      const double th_yaw = M_PI_2);

int8_t getLaneDirection(const std::vector<geometry_msgs::msg::Pose> & poses, double th_dist = 0.5);

bool isDirectionForward(const geometry_msgs::msg::Pose & prev, 
...
template <>
bool isInPolygon(const std::vector<geometry_msgs::msg::Point> & polygon, 
                const geometry_msgs::msg::Point & point);

double kmph2mps(const double velocity_kmph);
double normalizeEulerAngle(const double euler);

geometry_msgs::msg::Point transformToAbsoluteCoordinate2D(const geometry_msgs::msg::Point & point, 
                                                          const geometry_msgs::msg::Pose & current_pose);

geometry_msgs::msg::Point transformToRelativeCoordinate2D(const geometry_msgs::msg::Point & point, 
                                                          const geometry_msgs::msg::Pose & current_pose);
